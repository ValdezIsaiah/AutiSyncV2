...
//             <button  
//               onClick={handleLogin} 
//               className="btn-autism-friendly bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-3 rounded-xl font-semibold shadow-lg transform hover:scale-105 transition-all duration-300"
//             >
//               Log In
//             </button>
//           </div>
...
//                   <span className="block bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-text-shimmer">
//                     AutiSync
//                   </span>
//                 </h2>
...
//                 {[
//                   { emoji: '🧠', label: 'Smart Learning' },
//                   { emoji: '🎯', label: 'Goal Focused' },
//                   { emoji: '🌈', label: 'Colorful Journey' },
//                   { emoji: '⭐', label: 'Achievement' },
//                   { emoji: '🚀', label: 'Growth' }
//                 ].map((item, i) => (
//                   <div 
//                     key={i}
//                     className="card-autism-friendly w-16 h-16 bg-white/80 backdrop-blur-sm rounded-2xl flex flex-col items-center justify-center shadow-lg hover:shadow-xl border-2 border-white/30 cursor-pointer"
...
//           {/* Call to Action */}
//           <section className="pb-16">
//             <div className="max-w-2xl mx-auto bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 text-white shadow-2xl animate-float">
...
//       {/* Footer */}
//       <footer className="relative z-10 bg-white/80 backdrop-blur-xl border-t border-white/20 py-8">
//         <div className="container mx-auto px-6 text-center">
